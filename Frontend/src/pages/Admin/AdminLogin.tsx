...
import { BookOpen, Eye, EyeOff, ArrowLeft, Loader2, Shield } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { adminLogin } from '@/ApiConfig/AdminConnection';
...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Attempt to login
      const loginResponse = await adminLogin(adminEmail.trim(), password);
      
      if (loginResponse.success) {
        toast({
          title: "Welcome back, Admin!",
          description: "Successfully logged into your admin dashboard",
        });
      ...
      <div className="min-h-screen flex">
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-left">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-2xl font-bold text-foreground">IGA Admin</span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="adminEmail" className="text-sm font-medium text-foreground">Admin Email</Label>
                <Input
                  id="adminEmail"
                  type="email"
        ...
        <div className="flex-1 bg-white from-primary/10 to-primary/5 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="text-center p-8 max-w-md">
            <img 
              src={studentImage} 
              alt="Student learning - Admin portal" 
